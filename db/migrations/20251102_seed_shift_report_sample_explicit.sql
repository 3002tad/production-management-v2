...
-- Adjust shift_id / machine_id values if your DB uses different IDs.
...
INSERT INTO `shift_machine_reports` (`shift_id`, `machine_id`, `produced_qty`, `target_qty`, `downtime_seconds`, `events`, `status`, `last_updated_at`, `recorded_by`, `created_at`)
VALUES
...
INSERT INTO `shift_machine_events` (`shift_id`, `machine_id`, `event_type`, `detail`, `ts`, `created_by`)
VALUES
...
-- SELECT * FROM shift_machine_reports WHERE shift_id = 1001;
-- SELECT * FROM shift_machine_events WHERE shift_id = 1001;
