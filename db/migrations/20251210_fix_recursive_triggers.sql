-- =================================================================================================
-- Filename: 20251210_fix_recursive_triggers.sql
...
-- Step 1: Drop the old, faulty triggers
...
-- Also drop the new names in case of partial execution
...
BEGIN
    ...
    IF NEW.pr_status IN (1, 2) AND product_variant_count = 1 THEN
        ...
        IF qty_to_deduct > 0 THEN
            -- Directly modify the new row's values
...
-- =================================================================================================
-- RE-CREATE THE `AFTER DELETE` TRIGGER (This trigger was correct, but is re-created for completeness)
-- =================================================================================================
