...
CREATE TABLE `staff` (
  ...
  `staff_group` varchar(50) NOT NULL DEFAULT 'worker',
  `st_status` int(2) NOT NULL DEFAULT 1,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `staff` (`id_staff`, `staff_name`, `phone`, `email`, `department`, `position`, `staff_group`, `st_status`, `created_at`, `updated_at`) VALUES
(1001, 'Leader1', '08212312', 'leader1@mail.com', 'Production', 'Leader', 'leader', 2, '2025-12-13 00:00:00', '2025-12-13 00:00:00'),
(1002, 'Leader2', '08923321', 'leader2@mail.com', 'Production', 'Leader', 'leader', 1, '2025-12-13 00:00:00', '2025-12-13 00:00:00');
...
(9, 'testuser01', 'cc03e747a6a', NULL, 0, 7, 1011, 'công ', 'danh12345@gmail.com', '09378367788', 1, '2025-12-01 18:12:25', 1, '2025-12-01 16:02:29', '2025-12-11 15:22:31'),
(16, 'danh', '123456', NULL, 0, 1, 1012, 'anh', 'danh@gmail.com', '09877976688', 1, '2025-12-06 19:50:58', 1, '2025-12-03 08:55:13', '2025-12-11 15:22:31'),
(17, 'cong', 'B1E33B69', 'B1E33B69', 1, 1, 1013, 'cong danh', 'danh66667@gmail.com', '', 1, '2025-12-07 14:48:03', 1, '2025-12-07 14:38:47', '2025-12-11 15:22:31'),
(18, 'lead', '123456', NULL, 0, 4, 1033, 'danh', 'danh77656@gmail.com', '09769857', 1, '2025-12-11 18:48:57', 1, '2025-12-11 18:21:59', '2025-12-11 18:57:32'),
(19, 'lead1', '123456', NULL, 0, 4, 1001, 'Leader1', 'leader1@mail.com', '8212312', 1, '2025-12-11 19:26:40', 1, '2025-12-11 19:25:47', '2025-12-11 19:28:01');
-- --------------------------------------------------------
