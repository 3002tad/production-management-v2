                    ...
                    <table id="table" class="table align-items-center mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="text-xs font-weight-bold"><?= $row->id_cust; ?></span>
                                </td>
                                <td>
                                    <span class="text-xs font-weight-bold"><?= $row->cust_name; ?></span>
                                </td>
                                <td>
                                    <span class="text-xs font-weight-bold"><?= $row->address ?? 'N/A'; ?></span>
                                </td>
                                <td>
                                    <span class="text-xs font-weight-bold"><?= $row->phone ?? 'N/A'; ?></span>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
