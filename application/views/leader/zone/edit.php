    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0">
                ...
                <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="<?= site_url('leader/zone/detail/' . $zone->zone_id); ?>"><?= $zone->zone_name ?></a></li>
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
                        ...
                        <p class="mb-0">Chỉnh sửa thông tin khu vực</p>
                    </div>
                </div>
                <div class="card-body">
                    <form method="POST" action="<?= site_url('leader/zone/update/' . $zone->zone_id); ?>" id="editZoneForm">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="input-group input-group-static mb-4">
                                    <label>Mã khu *</label>
                                    <input type="text" class="form-control" name="zone_code" required maxlength="50" 
                                           value="<?= $zone->zone_code ?>" placeholder="VD: ZONE_A, ZONE_B">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group input-group-static mb-4">
                                    ...
                                    <input type="text" class="form-control" name="zone_name" required maxlength="100"
                                           value="<?= $zone->zone_name ?>" placeholder="VD: Khu A, Khu sản xuất chính">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-static mb-4">
                                    ...
                                    <input type="text" class="form-control" name="floor" maxlength="50"
                                           value="<?= $zone->floor ?>" placeholder="VD: Tầng 1, Tầng 2">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group input-group-static mb-4">
                                    ...
                                    <input type="text" class="form-control" name="building" maxlength="50"
                                           value="<?= $zone->building ?>" placeholder="VD: Nhà máy A, Nhà máy B">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="input-group input-group-static mb-4">
                                    ...
                                    <textarea class="form-control" name="description" rows="3"
                                              placeholder="Mô tả chi tiết về khu vực..."><?= $zone->description ?></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-static mb-4">
                                    ...
                                    <select class="form-control" name="status">
                                        <option value="1" <?= $zone->status == 1 ? 'selected' : '' ?>>Hoạt động</option>
                                        <option value="0" <?= $zone->status == 0 ? 'selected' : '' ?>>Ngừng hoạt động</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <a href="<?= site_url('leader/zone/detail/' . $zone->zone_id); ?>" class="btn btn-light m-0">
                                <i class="material-icons text-sm">arrow_back</i>&nbsp;&nbsp;Quay lại
                            </a>
                            <button type="submit" class="btn btn-primary m-0">
                                <i class="material-icons text-sm">save</i>&nbsp;&nbsp;Cập nhật Khu vực
                            </button>
                        </div>
                    </form>
                </div>
