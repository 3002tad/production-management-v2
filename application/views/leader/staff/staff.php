        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                <li class="breadcrumb-item text-sm">
                    <a class="opacity-5 text-dark" href="<?= site_url('leader/'); ?>">
        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class="card-body px-0 pb-2">
                    <!-- Filters -->
                    <form method="GET" action="<?= site_url('leader/staff'); ?>" class="row g-3 mb-3 px-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-2">
                            <select class="form-select" name="status">
                                ...
                                <option value="1" <?php echo (isset($_GET['status']) && $_GET['status'] == '1') ? 'selected' : ''; ?>>Sẵn sàng</option>
                                <option value="2" <?php echo (isset($_GET['status']) && $_GET['status'] == '2') ? 'selected' : ''; ?>>Đã xếp lịch</option>
                                <option value="3" <?php echo (isset($_GET['status']) && $_GET['status'] == '3') ? 'selected' : ''; ?>>Ngừng hoạt động</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <a href="<?= site_url('leader/staff'); ?>" class="btn btn-secondary w-100">
