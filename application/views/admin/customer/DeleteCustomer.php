<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0"><?= lang('btn_delete'); ?> <?= lang('breadcrumb_customers'); ?></h6>
            </nav>
        ...
        <div class="card-header card-header-primary">
            <div class="row">
                <div class="col-7 align-items-center pl-4">
                    <h4 class="mb-0"><?= lang('btn_delete'); ?> <?= lang('breadcrumb_customers'); ?></h4>
                    <span class="text-sm mb-0 text-end"><?= lang('label_confirm_delete'); ?></span>
                </div>
            </div>
            <div class="d-flex pt-4" method="post">
                ...
                <div class="col-4">
                    <div class="p-2">
                        <span><?= lang('msg_confirm_delete'); ?></span></br>
                    </div>
                    <div class="d-flex">
                        <div class="pt-2 pl-2">
