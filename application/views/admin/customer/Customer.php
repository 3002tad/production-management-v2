    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0"><?= lang('breadcrumb_customers'); ?></h6>
            </nav>
    ...
    <div class="card-header p-0 w-75 position-fixed mt-n4 mx-2 z-index-2">
        <div class="shadow-dark border-radius-lg d-flex px-5 pt-4 pb-3">
            <div class="col-8 d-flex align-items-center">
                ...
                <h6 class="mb-0"><?= lang('label_data_customers'); ?></h6>
            </div>
            <div class="col-4 text-end">
                <a href="<?= site_url('admin/customer/addcustomer'); ?>" class="btn bg-gradient-dark mb-0" title="<?= lang('btn_add_customer'); ?>"><?= lang('btn_add_customer'); ?></a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card">
            ...
            <div class="table-responsive p-0">
                ...
                <thead>
                        ...
                        <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7"><?= lang('table_company'); ?></th>
                        <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7"><?= lang('table_address'); ?></th>
                ...
                <?php if (!empty($customer)) : $i = 1; foreach (array_reverse($customer) as $value) : ?>
                    ...
                    <td>
                        <a href="<?= site_url('admin/customer/'.$value->id_cust.'/view'); ?>" rel="tooltip" title="<?= lang('label_edit_task'); ?>" class="btn btn-outline-info btn-link text-info btn-sm">
