<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0"><?= lang('label_add_machine'); ?></h6>
            </nav>
        ...
        <div class="card-header card-header-primary">
            <div class="row">
                <div class="col-7 align-items-center pl-4">
                    <h4 class="mb-0"><?= lang('title_create_new_machine'); ?></h4>
            ...
            <div class="d-flex pt-4" method="post">
                <div class="col-8">
                    ...
                    <form class="pt-4" action="<?= site_url('admin/addnewmachine'); ?>" method="post">
                        <span><?= lang('form_machine_name'); ?></span></br>
                        <div class="input-group input-group-dynamic mb-4">
                            <label class="form-label"></label>
                            <input type="text" name="machine_name" class="form-control">
                        </div>
                        <span><?= lang('label_capacity'); ?> (<?= lang('unit_pieces_per_hour'); ?>)</span></br>
                        <div class="input-group input-group-dynamic mb-4">
                            <label class="form-label"></label>
                            <input type="number" name="capacity" class="form-control" placeholder="VD: 500, 1000">
