            ...
            <div class="d-flex pt-4" method="post">
                ...
                <div class="col-4">
                    ...
                    <div class="d-flex flex-column gap-2">
                        <a class="btn btn-outline-dark btn-sm mb-2" href="<?= site_url('admin/staff'); ?>"><?= lang('btn_back'); ?></a>
                        <form action="<?= site_url('admin/deleteStaff/'.$detail['id_staff']); ?>" method="POST" style="display:inline;">
