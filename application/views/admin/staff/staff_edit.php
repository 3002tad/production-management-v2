    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="card">
                ...
                <form action="<?php echo site_url('admin/staff/edit_process'); ?>" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="phone" name="phone" value="<?php echo $staff->phone; ?>" placeholder="0xxxxxxxxx">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="department" name="department">
                                ...
                                <?php foreach ($departments as $dept): ?>
                                    <option value="<?php echo $dept; ?>" <?php echo ($staff->department == $dept) ? 'selected' : ''; ?>><?php echo $dept; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="st_status" name="st_status">
                                <option value="1" <?php echo ($staff->st_status == 1) ? 'selected' : ''; ?>>Active</option>
                                <option value="2" <?php echo ($staff->st_status == 2) ? 'selected' : ''; ?>>Inactive</option>
                            </select>
                        </div>
