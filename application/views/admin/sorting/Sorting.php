            ...
            <div class="card my-2">
                ...
                <div class="shadow-dark border-radius-lg d-flex px-5 pt-4 pb-3">
                    ...
                    <i class="material-icons pr-3">schedule</i>
                      <h6 class="mb-0"><?= lang('label_production_report'); ?></h6>
                    </div>
                </div>
                ...
                <div class="table-responsive p-0">
                    ...
                    <?php if (!empty($sorting)) : $i = 1; foreach ($sorting as $value) : ?>
                        ...
                        <td class="pl-4">
                            <span class="text-sm font-weight-bold"><?= $value->qty_target; ?> <?= lang('unit_pieces'); ?></span>
                        </td>
                        <td class="pl-4">
                            <span class="text-sm font-weight-bold"><?= $value->finished; ?> <?= lang('unit_pieces'); ?></span>
                        </td>
                        <td class="pl-4">
                            <span class="text-sm font-weight-bold"><?= $value->waste; ?> <?= lang('unit_pieces'); ?></span>
                        </td>
                        <td>
                        <a href="<?= site_url('admin/detail_sorting/'.$value->id_planshift.'/print'); ?>" rel="tooltip" title="<?= lang('tooltip_detail'); ?>"  class="badge bg-gradient-secondary"><?= lang('btn_print_out'); ?></a>
                        </td>
                        </tr>
