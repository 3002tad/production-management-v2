    ...
    <div class="card-header p-0 w-75 position-fixed mt-n4 mx-2 z-index-2">
        <div class="shadow-dark border-radius-lg d-flex px-5 pt-4 pb-3">
            <div class="col-8 d-flex align-items-center"> 
                ...
                <h6 class="col mb-0"><?= lang('label_shiftment_production'); ?></h6>
            </div>
            <div class="col-4 text-end">
                <a href="<?= site_url('admin/plan_shift/addshiftment'); ?>" class="btn bg-gradient-dark mb-0"><?= lang('btn_add_shiftment'); ?></a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="table-responsive p-0">
                <table id="table-data" class="table align-items-center justify-content-center mb-0">
                    <thead>
                            ...
                            <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7"><?= lang('table_time_process'); ?></th>
                            <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7"><?= lang('table_date_process'); ?></th>
                    ...
                    <tbody class="pl-3">
                        <?php if (!empty($plan_shift)) : $i = 1; foreach ($plan_shift as $value) : ?>
                            ...
                            <td class="pl-4">
                                <a href="<?= site_url('admin/plan_shift/'.$value->id_planshift.'/delete'); ?>" rel="tooltip" title="<?= lang('tooltip_remove'); ?>" class="btn btn-outline-danger btn-link btn-sm" >
