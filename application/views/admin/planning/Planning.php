    ...
    <div class="card-header p-0 w-75 position-fixed mt-n4 mx-2 z-index-2">
        <div class="shadow-dark border-radius-lg d-flex px-5 pt-4 pb-3">
            ...
            <div class="col-4 text-end">
                <a href="<?= site_url('admin/planning/addplanning'); ?>" class="btn bg-gradient-dark mb-0"><?= lang('btn_add_planning'); ?></a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="table-responsive p-0">
                ...
                <thead>
                    ...
                    <?php if (!empty($planning)) : $i = 1; foreach ($planning as $value) : ?>
                        ...
                        <td class="pl-4">
                            <span class="text-sm font-weight-bold"><?= $value->qty_request; ?> <?= lang('unit_pieces'); ?> / <?= $value->diameter; ?> <?= lang('unit_mm'); ?></span>
                        </td>
                        <td class="pl-4">
                            <span class="text-sm font-weight-bold"><?= $value->qty_target; ?> <?= lang('unit_pieces'); ?> /<?= lang('table_shiftment'); ?></span>
                        </td>
                        <td class="pl-4">
                        ...
                        <td>
                        <a href="<?= site_url('admin/plan_shift/'.$value->id_plan.'/view'); ?>" rel="tooltip" title="<?= lang('btn_view_details'); ?>"  class="badge bg-gradient-secondary"><?= lang('btn_view_details'); ?></a>
                        </td>
                        </tr>
