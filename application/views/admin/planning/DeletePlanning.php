<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0"><?= lang('label_delete_planning'); ?></h6>
            </nav>
        ...
        <div class="card-header card-header-primary">
            <div class="row">
                <div class="col-7 align-items-center pl-4">
                    <h4 class="mb-0"><?= lang('title_delete_planning'); ?></h4>
                    <span class="text-sm mb-0 text-end"><?= lang('subtitle_delete_planning'); ?></span>
                </div>
            </div>
            <div class="d-flex pt-4" method="post">
                    ...
                    <div class="row d-flex">
                        ...
                        <div class="col-5">
                            ...
                            <select class="selectpicker form-control" name="id_product" data-style="btn btn-link" data-live-search="true">
                                <option disabled selected><?= lang('form_select_project'); ?></option>
                ...
                <div class="col-4">
                    <div class="p-2">
                        <span><?= lang('msg_confirm_delete_planning'); ?></span></br>
                    </div>
                    <div class="d-flex">
                        <div class="pt-2 pl-2">
