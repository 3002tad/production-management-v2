<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0"><?= lang('btn_add_production'); ?></h6>
            </nav>
        ...
        <div class="card-header card-header-primary">
            <div class="row">
                <div class="col-7 align-items-center pl-4">
                    <h4 class="mb-0"><?= lang('title_add_production'); ?></h4>
                    <span class="text-sm mb-0 text-end"><?= lang('subtitle_add_production'); ?></span>
                </div>
            </div>
            <div class="d-flex pt-4" method="post">
                    ...
                    <form class="pt-4" action="<?= site_url('admin/addShiftment'); ?>" method="post">
                            ...
                            <div class="input-group input-group-dynamic mb-4">
                                <select class="selectpicker form-control text-md"name="id_plan" data-style="btn btn-primary btn-round" data-live-search="true">
                                    <option disabled selected><?= lang('form_select_production'); ?></option>
                ...
                <div class="col-4">
                    <div class="pr-2">
                        <span><?= lang('msg_confirm_save_production'); ?></span></br>
                    </div>
                    <div class="d-flex">
                        <div class="pt-2 pl-2">
