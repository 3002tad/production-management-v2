        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><?= lang('breadcrumb_warehousing'); ?></li>
                </ol>
                <h6 class="font-weight-bolder mb-0"><?= lang('label_finished_production'); ?></h6>
            </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            <h6 class="text-sm font-weight-bolder mb-0"><?= lang('label_production_system'); ?></h6>
            </div>
        </div>
    </nav>
</br>
            ...
            <div class="card my-2">
                ...
                <div class="shadow-dark border-radius-lg d-flex px-5 pt-4 pb-3">
                    ...
                    <i class="material-icons pr-3">schedule</i>
                      <h6 class="mb-0"><?= lang('label_warehousing'); ?></h6>
                    </div>
                </div>
                ...
                <div class="table-responsive p-0">
                    ...
                    <thead>
                        ...
                        <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7"><?= lang('table_customer'); ?></th>
                        <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7"><?= lang('table_last_date'); ?></th>
                        <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7"><?= lang('table_qty_request'); ?></th>
                        <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7"><?= lang('table_total_finished'); ?></th>
                        </tr>
                    </thead>
                    <tbody class="pl-3">
                    <?php if (!empty($finished)) : $i = 1; foreach ($finished as $value) : ?>
                        ...
                        <td class="pl-4">
                            <span class="text-sm font-weight-bold"><?= $value->qty_request; ?> <?= lang('unit_pieces'); ?></span>
                        </td>
                        <td class="pl-4">
                            <span class="text-sm font-weight-bold"><?= $value->total_finished; ?> <?= lang('unit_pieces'); ?></span>
                        </td>
                        </tr>
