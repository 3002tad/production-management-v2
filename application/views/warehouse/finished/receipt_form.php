<!-- Form Tạo Phiếu Nhập Thành Phẩm -->
<div class="card">
          ...
          <form method="post" action="<?= site_url('warehouse/finished/receipt_save'); ?>" class="needs-validation">
            ...
            <div class="d-flex gap-2">
              ...
              <button type="reset" class="btn btn-secondary">
                <i class="material-icons align-middle">refresh</i> Đặt Lại
              </button>
              <button onclick="hideAllContainers()" type="button" class="btn btn-secondary">
                <i class="material-icons align-middle">close</i> Đóng
              </button>
            </div>
