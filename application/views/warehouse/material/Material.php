  ...
  <div class="card-header p-0 w-75 position-fixed mt-n4 mx-2 z-index-2">
    <div class="shadow-dark border-radius-lg d-flex px-5 pt-4 pb-3">
      ...
      <div class="col-4 text-end">
        <a href="<?= site_url('warehouse/material/addnewmaterial'); ?>" class="btn badge-sm bg-gradient-secondary mb-0"><?= lang('btn_add_material'); ?></a>
      </div>
    </div>
  </div>
</div>
            ...
            <table id="table-data" class="table align-items-center justify-content-center mb-0">
              ...
              <tbody class="pl-3">
                ...
                <tr>
                  ...
                  <td class="pl-4">
                    <a href="<?= site_url('warehouse/editMaterial/'.$value->id_material); ?>" class="btn btn-info btn-link btn-sm">
                      <i class="material-icons">edit</i>
                    </a>
                    <a href="<?= site_url('warehouse/deleteMaterialMaster/'.$value->id_material); ?>" onclick="return confirm('<?= lang('msg_confirm_delete_data');?>');" class="btn btn-danger btn-link btn-sm">
