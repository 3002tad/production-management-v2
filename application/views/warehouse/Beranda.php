                        ...
                        <table class="table table-hover">
                            ...
                            <?php if (!empty($finished)) : $i = 1; foreach ($finished as $value) : ?>
                                ...
                                <tr>
                                    ...
                                    <td class ="pl-4"> <?= $value->qty_request?> <?= lang('unit_pieces'); ?></td>
                                    <td class ="pl-4"> <?= $value->total_finished?> <?= lang('unit_pieces'); ?></td>
                                </tr>
                        ...
                        <table class="table table-hover">
                            ...
                            <?php if (!empty($sorting)) : $i = 1; foreach ($sorting as $value) : ?>
                                <tr>
                                    ...
                                    <td class ="pl-4"> <?= $value->finished?> <?= lang('unit_pieces'); ?></td>
                                </tr>
                            <?php  endforeach; endif;?>
                            </tbody>
                        </table>
