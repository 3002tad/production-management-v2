                ...
                <div class="card-header card-header-primary">
                    <div class="row">
                        <div class="col-7 align-items-center pl-4">
                            ...
                            <span class="text-sm mb-0 text-end">Form thêm nhân viên</span>
                        </div>
                    </div>
                </div>
                <div class="d-flex pt-4">
                    <div class="col-8">
                        <div class="card border-0 d-flex p-4 pt-0 mb-2 bg-gray-100">
                            ...
                            <form class="pt-4" action="<?php echo base_url('leader/addStaff'); ?>" method="post">
                                <span>Tên nhân viên</span></br>
                                <div class="input-group input-group-dynamic mb-4">
                                    <input type="text" class="form-control" name="staff_name" value="<?php echo set_value('staff_name'); ?>" required>
                                </div>
                                ...
                                <div class="input-group input-group-dynamic mb-4">
                                    <select class="form-control" name="st_status">
                                        <option value="1" <?php echo set_select('st_status', '1', TRUE); ?>>Hoạt động</option>
                                        <option value="0" <?php echo set_select('st_status', '0'); ?>>Ngừng hoạt động</option>
                                    </select>
                                </div>
                        </div>
                    </div>
